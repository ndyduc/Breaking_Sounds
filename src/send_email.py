...
def send_email(email, username):
	...
	email_body = render_template('support/verify_email.html', username=username, verify_url=verify_url)
...
def send_forgot(email, username):
	...
	email_body = render_template('support/email_forgot_password.html', username=username, verify_url=verify_url)
